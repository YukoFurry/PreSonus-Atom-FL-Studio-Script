...
For information on where to put the file please see [Image-Lines guide on midi scripts under Script Locations and File Names]([url](https://www.image-line.com/fl-studio-learning/fl-studio-online-manual/html/midi_scripting.htm))
